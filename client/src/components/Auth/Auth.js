...
const Auth = () => {          
    ...
    const googleSuccess = async (res) => {
        const result = res?.profileObj; // ?. does not throw an error if res object is not found
            ...
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin 
                        ...
                        clientId="398435869481-13mr3su23960a4st2kn9oif8csaskp88.apps.googleusercontent.com"
